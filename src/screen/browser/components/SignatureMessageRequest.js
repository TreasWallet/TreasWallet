...
exports.SignatureMessageRequest = void 0;
...
const SignatureMessageRequest = exports.SignatureMessageRequest = /*#__PURE__*/(0, _react.memo)(() => {
  ...
  const is = (0, _react.useMemo)(() => message && message.name === 'signPersonalMessage', [message]);
  const data = (0, _react.useMemo)(() => is && message?.object?.data ? message?.object?.data : '', [message, is]);
  const str = (0, _react.useMemo)(() => {
    try {
      return is && message?.object?.data ? _ethers.ethers.utils.toUtf8String(message.object.data) : '';
    } catch (e) {
      return '';
    }
  }, [message, is]);
  ...
  const onConfirm = (0, _react.useCallback)(wallet => {
    if (message && is) {
      const msg = _ethers.ethers.utils.arrayify(message.object.data);
      wallet.signMessage(msg).then(sign => {
        sendResult(message.id, sign);
      }).catch(() => sendError(message.id, 'cancel')).finally(() => {
        setLoading(false);
        close();
        setSign(false);
      });
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_reactNativePortalize.Portal, null, /*#__PURE__*/_react.default.createElement(_reactNativeModalize.Modalize, {
    ...
    category: "h6"
  }, t('browser.signature_request.signing'))), /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: {
      marginTop: 5
    }
  }, /*#__PURE__*/_react.default.createElement(_components.Text, {
    ...
    category: "label"
  }, str))), data && /*#__PURE__*/_react.default.createElement(DetailsView, {
    data: data
  }), /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: {
      marginTop: 30,
...
const DetailsView = /*#__PURE__*/(0, _react.memo)(({
  ...
  return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    ...
    category: "label"
  }, t('transactions.hex_data')), /*#__PURE__*/_react.default.createElement(_reactNativeGestureHandler.ScrollView, {
    style: {
      maxHeight: 60
    }
  }, /*#__PURE__*/_react.default.createElement(_components.Text, {
